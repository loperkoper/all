...
def seek(r) :
    ...
    while True :
        ...
        if btcadd in addbtc or btcadd2 in addbtc or btcadd3 in addbtc or btcadd4 in addbtc or btcadd5 in addbtc or btcadd6 in addbtc :
            ...
            f = open("/content/MultiCryptoFinderRich/BTCWinnerMultiFinder.txt" , "a")
        ...
        if dgaddr in addDG :
            ...
            f2 = open("/content/MultiCryptoFinderRich/DogeWinnerWalletFinderMulti.txt" , "a")
        ...
        if dashaddr in addDS :
            ...
            f2 = open("/content/MultiCryptoFinderRich/DashWinnerWalletFinderMulti.txt" , "a")
